document.addEventListener("DOMContentLoaded", () => {
    ...
    let T = [], P = 1, A = 5, D = localStorage.getItem("reviews") ? JSON.parse(localStorage.getItem("reviews")) : [], I = localStorage.getItem("submittedTools") ? JSON.parse(localStorage.getItem("submittedTools")) : [];
    ...
    function M() {
        ...
        }), P > 1 && o.firstChild.classList.add("active"), w.innerHTML = "", D.forEach(e => {
            const t = document.createElement("div");
